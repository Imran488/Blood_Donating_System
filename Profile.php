...
<div class="manageDonors">
	...
	<center><h1 class='buttonc' title='Create New Contact'><u>Donors Profile</u></h1></center>
...
<center>
		<tbody>
			...
			$sql = "SELECT name,blood_group,gender,email,contact_no,city,date,dateb,password FROM donate_form"  ;
	...
	<center><a href="dashboard.php">Back to the Homepage</a></center>
</div>
